...
import { _mockFormControls, _makeid } from './formControls';
// FORNITORI
...
export const aFornitori =
    Array.from({ length: 10 }, () => Object.assign({ id: _makeid(30) }, _mockFormControls(aFornitoriProperties)))
...
export const oInitialClienti = aClientiProperties.reduce((o, key) => Object.assign(o, { [key.property]: key.initialValue }), {});
export const aClienti =
    Array.from({ length: 10 }, () => Object.assign({ id: _makeid(30) }, _mockFormControls(aClientiProperties)))
...
export const oInitialTipoCollo = aTipoColloProperties.reduce((o, key) => Object.assign(o, { [key.property]: key.initialValue }), {});
export const aTipoCollo =
    Array.from({ length: 10 }, () => Object.assign({ id: _makeid(30) }, _mockFormControls(aTipoColloProperties)))
...
export const oInitialTipoCassa = aTipoCassaProperties.reduce((o, key) => Object.assign(o, { [key.property]: key.initialValue }), {});
export const aTipoCassa =
    Array.from({ length: 10 }, () => Object.assign({ id: _makeid(30) }, _mockFormControls(aTipoCassaProperties)))
