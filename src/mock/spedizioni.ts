...
import { _makeCharacters, _mockFormControls } from '../config/formControls';

export const aSpedizioniControls: IFormControl[] = [
...
export const oInitialSpedizioniControls =
    aSpedizioniControls.reduce((o, key) => Object.assign(o, { [key.property]: key.initialValue }), {});
export const aSpedizioni =
    Array.from({ length: 15 }, () => Object.assign({ id: _makeCharacters(30) }, _mockFormControls(aSpedizioniControls)))